# =============================================================================
# Cosmos Chronic Disease Data Ingestion
# Source: https://github.com/PopHIVE/epic_preprocessing/tree/main/data/cosmos_chronic
# Pulls pre-processed standard files from the epic_preprocessing repository.
# Includes: diabetes A1C and obesity BMI at state and county levels (annual).
# =============================================================================
...
# GitHub raw base URL
base_url <- "https://raw.githubusercontent.com/PopHIVE/epic_preprocessing/main/data/cosmos_chronic"
