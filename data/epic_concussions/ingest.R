# =============================================================================
# Cosmos Concussion Data Ingestion
# Source: https://github.com/PopHIVE/epic_preprocessing
#         tree/main/data/cosmos_concussions
# Pulls pre-processed standard files from the epic_preprocessing repository.
# Includes: ED encounter counts and percentages with a concussion diagnosis,
# by state, month, age at time of visit, and evaluated sex.
# =============================================================================
...
# GitHub raw base URL
base_url <- "https://raw.githubusercontent.com/PopHIVE/epic_preprocessing/main/data/cosmos_concussions"
