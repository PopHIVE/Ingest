# =============================================================================
# Cosmos Hepatitis B Birth Vaccination Data Ingestion
# Source: https://github.com/PopHIVE/epic_preprocessing
#         tree/main/data/cosmos_hepb_vax
# Pulls pre-processed standard files from the epic_preprocessing repository.
# Includes: HepB birth dose vaccination rates by state, monthly.
# =============================================================================
...
# GitHub raw base URL
base_url <- "https://raw.githubusercontent.com/PopHIVE/epic_preprocessing/main/data/cosmos_hepb_vax"
