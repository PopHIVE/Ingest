...
flowchart LR
    ...
    s31(("<strong><a href="https://data.cdc.gov" target="_blank" rel="noreferrer">Center of Medicare and Medicaid Services (CMS)</a></strong>"))
    s33(("<strong><a href="https://data.cms.gov/tools/mapping-medicare-disparities-by-population" target="_blank" rel="noreferrer">Mapping Medicare Disparities by Population Tool</a></strong>"))
    s34(("<strong><a href="https://delphi.cmu.edu/epidata/v5/" target="_blank" rel="noreferrer">CMU Delphi Epidata - Outpatient Claims</a></strong>"))
    s36(("<strong><a href="https://delphi.cmu.edu/epidata/v5/" target="_blank" rel="noreferrer">CMU Delphi Epidata - Inpatient Claims</a></strong>"))
    ...
    subgraph cms_mmd["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/cms_mmd" target="_blank" rel="noreferrer">cms_mmd</a></strong>`"]
        direction LR
        n26["`data_state_county_age_by_race.csv.gz`"]:::pass
        n27["`data_state_county_age_by_sex.csv.gz`"]:::pass
        n28["`data_state_county_age.csv.gz`"]:::pass
    end
    ...
    subgraph epic_chronic["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/epic_chronic" target="_blank" rel="noreferrer">epic_chronic</a></strong>`"]
        direction LR
        n33["`county_no_time.csv.gz<br/><br/><ul><li><code>missing_info: bmi_30_49.8, obesity_(%), n_obesity_county, Year</code></li></ul>`"]:::warn
        n34["`county_year.csv.gz`"]:::pass
        n35["`state_no_time.csv.gz<br/><br/><ul><li><code>missing_info: bmi_30_49.8, dm_(%), n_patients, Year</code></li></ul>`"]:::warn
        n36["`state_year.csv.gz`"]:::pass
    end
    subgraph epic_concussions["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/epic_concussions" target="_blank" rel="noreferrer">epic_concussions</a></strong>`"]
        direction LR
        n37["`data.csv.gz<br/><br/><ul><li><code>missing_info: age, sex</code></li></ul>`"]:::warn
    end
    subgraph epic_diarrhea["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/epic_diarrhea" target="_blank" rel="noreferrer">epic_diarrhea</a></strong>`"]
        direction LR
        n38["`data_weekly.csv.gz`"]:::pass
        n39["`weekly_tests.csv.gz`"]:::pass
    end
    ...
    subgraph epic_injury["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/epic_injury" target="_blank" rel="noreferrer">epic_injury</a></strong>`"]
        direction LR
        n42["`heat_year_county.csv.gz<br/><br/><ul><li><code>missing_info: geography_name</code></li></ul>`"]:::warn
        n43["`monthly_injury.csv.gz`"]:::pass
        n44["`yearly_injury.csv.gz`"]:::pass
    end
    subgraph epic_resp_infections["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/epic_resp_infections" target="_blank" rel="noreferrer">epic_resp_infections</a></strong>`"]
        direction LR
        n45["`monthly_tests.csv.gz`"]:::pass
        n46["`quarterly_gas.csv.gz`"]:::pass
        n47["`weekly.csv.gz`"]:::pass
    end
    subgraph gtrends["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/gtrends" target="_blank" rel="noreferrer">gtrends</a></strong>`"]
        direction LR
        n48["`data_dma_year.csv.gz`"]:::pass
        n49["`data_dma.csv.gz`"]:::pass
        n50["`data_year.csv.gz`"]:::pass
    ...
    subgraph hud_chas["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/hud_chas" target="_blank" rel="noreferrer">hud_chas</a></strong>`"]
        direction LR
        n52["`data_county.csv.gz`"]:::pass
        n53["`data_state.csv.gz`"]:::pass
    end
    subgraph kinsa_ili["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/kinsa_ili" target="_blank" rel="noreferrer">kinsa_ili</a></strong>`"]
        direction LR
        n54["`data.csv.gz<br /><br />Script Failed:<br />Kinsa credentials not found. Set KINSA_EMAIL and KINSA_PASSWORD.`"]:::fail
    end
    subgraph measles_age_cdc2["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/measles_age_cdc2" target="_blank" rel="noreferrer">measles_age_cdc2</a></strong>`"]
        direction LR
        n55["`data.csv.gz<br/><br/><ul><li><code>missing_info: year, week</code></li></ul>`"]:::warn
    end
    ...
    subgraph mmr_healthmap["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/mmr_healthmap" target="_blank" rel="noreferrer">mmr_healthmap</a></strong>`"]
        direction LR
        n61["`data_county.csv.gz`"]:::pass
        n62["`data_state.csv.gz`"]:::pass
        n63["`data_zcta.csv.gz`"]:::pass
    end
    subgraph narms["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/narms" target="_blank" rel="noreferrer">narms</a></strong>`"]
        direction LR
        n64["`data_animal_pathogen.csv.gz`"]:::pass
        n65["`data_food_animals.csv.gz`"]:::pass
        n66["`data_resistance_agent.csv.gz`"]:::pass
        n67["`data_resistance_pattern.csv.gz`"]:::pass
        n68["`data_retail_meats.csv.gz`"]:::pass
    end
    subgraph nccr["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/nccr" target="_blank" rel="noreferrer">nccr</a></strong>`"]
        direction LR
        n69["`data.csv.gz<br/><br/><ul><li><code>missing_info: age, sex, race_ethnicity</code></li></ul>`"]:::warn
    end
    subgraph nchs_mortality["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/nchs_mortality" target="_blank" rel="noreferrer">nchs_mortality</a></strong>`"]
        direction LR
        n70["`data_county.csv.gz`"]:::pass
        n71["`data_state_21_causes.csv.gz`"]:::pass
    ...
    subgraph neiss["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/neiss" target="_blank" rel="noreferrer">neiss</a></strong>`"]
        direction LR
        n73["`data_agegroup_diagnosis_rate.csv.gz`"]:::pass
        n74["`data_agegroup_diagnosis.csv.gz`"]:::pass
        n75["`data_agegroup_product_rate.csv.gz`"]:::pass
        n76["`data_agegroup_product.csv.gz`"]:::pass
        n77["`data_infant_diagnosis_rate.csv.gz`"]:::pass
        n78["`data_infant_diagnosis.csv.gz`"]:::pass
        n79["`data_infant_product_rate.csv.gz`"]:::pass
        n80["`data_infant_product.csv.gz`"]:::pass
    end
    subgraph nhtsa_crash["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/nhtsa_crash" target="_blank" rel="noreferrer">nhtsa_crash</a></strong>`"]
        direction LR
        n81["`data_age_sex.csv.gz<br/><br/><ul><li><code>missing_info: age, sex</code></li></ul>`"]:::warn
        n82["`data_crash_type.csv.gz<br/><br/><ul><li><code>missing_info: age, sex</code></li></ul>`"]:::warn
        n83["`data_person_type.csv.gz<br/><br/><ul><li><code>missing_info: person_type</code></li></ul>`"]:::warn
    ...
    subgraph nis["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/nis" target="_blank" rel="noreferrer">nis</a></strong>`"]
        direction LR
        n85["`data_insurance.csv.gz`"]:::pass
        n86["`data_urban.csv.gz`"]:::pass
    ...
    subgraph nnds["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/nnds" target="_blank" rel="noreferrer">nnds</a></strong>`"]
        direction LR
        n88["`data.csv.gz<br/><br/><ul><li><code>missing_info: mmwr_year, mmwr_week, anthrax, plague, rabies_human, rubella_congenital_syndrome, cronobacter_invasive_infection_infants_confirmed</code></li></ul>`"]:::warn
    end
    ...
    subgraph schoolvax_washpost["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/schoolvax_washpost" target="_blank" rel="noreferrer">schoolvax_washpost</a></strong>`"]
        direction LR
        n94["`data_counties.csv.gz`"]:::pass
        n95["`data_schools.csv.gz`"]:::pass
    end
    subgraph schoolvaxview["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/schoolvaxview" target="_blank" rel="noreferrer">schoolvaxview</a></strong>`"]
        direction LR
        n96["`data_exemptions.csv.gz`"]:::pass
    ...
    subgraph vaccine_exemptions_fattah["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/vaccine_exemptions_fattah" target="_blank" rel="noreferrer">vaccine_exemptions_fattah</a></strong>`"]
        direction LR
        n99["`data_county.csv.gz<br/><br/><ul><li><code>missing_info: is_state_estimate</code></li></ul>`"]:::warn
    ...
    subgraph yrbss["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/yrbss" target="_blank" rel="noreferrer">yrbss</a></strong>`"]
        direction LR
        n106["`data_age_ethnicity.csv.gz<br/><br/><ul><li><code>missing_info: age, race_ethnicity</code></li></ul>`"]:::warn
        n107["`data_age_sex.csv.gz<br/><br/><ul><li><code>missing_info: age, sex</code></li></ul>`"]:::warn
        n108["`data_age.csv.gz<br/><br/><ul><li><code>missing_info: age</code></li></ul>`"]:::warn
    end
    subgraph bundle_antimicrobial_resistance["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_antimicrobial_resistance" target="_blank" rel="noreferrer">bundle_antimicrobial_resistance</a></strong>`"]
        direction LR
        n109["`resistance_by_agent.parquet`"]
        n110["`resistance_by_pattern.parquet`"]
    end
    subgraph bundle_cancer_screening["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_cancer_screening" target="_blank" rel="noreferrer">bundle_cancer_screening</a></strong>`"]
        direction LR
        n111["`cms_cancer_screening_by_race.parquet`"]
        n112["`cms_cancer_screening_by_sex.parquet`"]
        n113["`cms_cancer_screening_state.parquet`"]
        n114["`combined_cancer_screening.parquet`"]
        n115["`medicaid_cancer_screening.parquet`"]
        n116["`nccr_incidence.parquet`"]
    end
    subgraph bundle_census["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_census" target="_blank" rel="noreferrer">bundle_census</a></strong>`"]
        direction LR
        n117["`census_county.parquet`"]
        n118["`census_state.parquet`"]
    end
    subgraph bundle_childhood_immunizations["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_childhood_immunizations" target="_blank" rel="noreferrer">bundle_childhood_immunizations</a></strong>`"]
        direction LR
        n119["`nis_insurance.parquet`"]
        n120["`nis_overall.parquet`"]
        n121["`nis_urban.parquet`"]
        n122["`overall_rates_by_source.parquet`"]
        n123["`schoolvaxview_exemptions.parquet`"]
        n124["`schoolvaxview_overall.parquet`"]
        n125["`state_compare.parquet`"]
        n126["`wapo_vax_counties.parquet`"]
        n127["`wapo_vax_schools.parquet`"]
    end
    subgraph bundle_chronic_diseases["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_chronic_diseases" target="_blank" rel="noreferrer">bundle_chronic_diseases</a></strong>`"]
        direction LR
        n128["`brfss_prevalence_by_geography.parquet`"]
        n129["`epic_prevalence_by_geography_county_and_source.parquet`"]
        n130["`epic_prevalence_by_geography_year.parquet`"]
        n131["`prevalence_by_geography_and_source.csv`"]
        n132["`prevalence_by_geography_and_year_and_source.parquet`"]
    end
    subgraph bundle_county_access["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_county_access" target="_blank" rel="noreferrer">bundle_county_access</a></strong>`"]
        direction LR
        n133["`county_access.parquet`"]
        n134["`county_determinants.parquet`"]
        n135["`state_determinants.parquet`"]
    end
    ...
    subgraph bundle_enteric_diseases["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_enteric_diseases" target="_blank" rel="noreferrer">bundle_enteric_diseases</a></strong>`"]
        direction LR
        n137["`enteric_diseases.parquet`"]
        n138["`epic_diarrhea.parquet`"]
        n139["`epic_health_alerts.parquet`"]
        n140["`resistance_by_agent.parquet`"]
        n141["`resistance_by_pattern.parquet`"]
    end
    subgraph bundle_injury_overdose["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_injury_overdose" target="_blank" rel="noreferrer">bundle_injury_overdose</a></strong>`"]
        direction LR
        n142["`county_opioid_by_source.parquet`"]
        n143["`deaths_cause_age_demographics.parquet`"]
        n144["`deaths_cause_age.parquet`"]
        n145["`firearms_by_demographics.parquet`"]
        n146["`firearms_by_geography_and_source_state_year.parquet`"]
        n147["`firearms_geography_source.parquet`"]
        n148["`google_dma.parquet`"]
        n149["`heat_by_geography_and_source_state_year.parquet`"]
        n150["`heat_risk.parquet`"]
        n151["`medicaid_injury_overdose.parquet`"]
        n152["`overdose_by_demographics.parquet`"]
        n153["`overdose_by_geography_and_source_county.parquet`"]
        n154["`overdose_by_geography_and_source_state_year.parquet`"]
        n155["`overdose_by_geography_and_source.parquet`"]
        n156["`overdose_deaths_county.parquet`"]
        n157["`overdose_deaths_state.parquet`"]
        n158["`state_opioid_by_source.parquet`"]
    end
    subgraph bundle_maternal_health["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_maternal_health" target="_blank" rel="noreferrer">bundle_maternal_health</a></strong>`"]
        direction LR
        n159["`maternal_county.parquet`"]
        n160["`maternal_mortality.parquet`"]
        n161["`maternal_state.parquet`"]
    end
    subgraph bundle_measles["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_measles" target="_blank" rel="noreferrer">bundle_measles</a></strong>`"]
        direction LR
        n162["`measles_cases_by_age.parquet`"]
        n163["`measles_county.parquet`"]
        n164["`measles_state.parquet`"]
    end
    subgraph bundle_preventative_services["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_preventative_services" target="_blank" rel="noreferrer">bundle_preventative_services</a></strong>`"]
        direction LR
        n165["`cms_preventative_services_by_race.parquet`"]
        n166["`cms_preventative_services_by_sex.parquet`"]
        n167["`cms_preventative_services_state.parquet`"]
        n168["`combined_preventative_services.parquet`"]
        n169["`medicaid_preventative_services.parquet`"]
    end
    subgraph bundle_respiratory["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_respiratory" target="_blank" rel="noreferrer">bundle_respiratory</a></strong>`"]
        direction LR
        n170["`abcs_strep.parquet`"]
        n171["`covid_ed_visits_by_county.parquet`"]
        n172["`covid_overall_trends.parquet`"]
        n173["`covid_trends_by_age.parquet`"]
        n174["`flu_ed_visits_by_county.parquet`"]
        n175["`flu_overall_trends.parquet`"]
        n176["`flu_trends_by_age.parquet`"]
        n177["`gas_state.parquet`"]
        n178["`other_measures_trends.parquet`"]
        n179["`pneumococcus_by_geography_year.parquet`"]
        n180["`pneumococcus_by_geography.parquet`"]
        n181["`pneumococcus_comparison.parquet`"]
        n182["`pneumococcus_serotype_trends.parquet`"]
        n183["`rsv_ed_visits_by_county.parquet`"]
        n184["`rsv_google_dma.parquet`"]
        n185["`rsv_overall_trends.parquet`"]
        n186["`rsv_positive_tests.parquet`"]
        n187["`rsv_testing_pct.parquet`"]
        n188["`rsv_trends_by_age.parquet`"]
    end
    ...
    subgraph bundle_youth_wellbeing["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_youth_wellbeing" target="_blank" rel="noreferrer">bundle_youth_wellbeing</a></strong>`"]
        direction LR
        n190["`chr_county.parquet`"]
        n191["`chr_state.parquet`"]
        n192["`epic_chronic_county_age.parquet`"]
        n193["`epic_chronic_state_age.parquet`"]
        n194["`epic_injury_state_age_month.parquet`"]
        n195["`epic_injury_state_age_year.parquet`"]
        n196["`immunizations_state_age_vaccine.parquet`"]
        n197["`medicaid_state_payer.parquet`"]
        n198["`neiss_diagnosis_age_sex_year.parquet`"]
        n199["`neiss_product_age_sex_year.parquet`"]
        n200["`nhtsa_county_age_sex.parquet`"]
        n201["`nhtsa_state_age_sex.parquet`"]
        n202["`noaa_heat_risk_county.parquet`"]
        n203["`noaa_heat_risk_state.parquet`"]
        n204["`wisqars_state_age_demographics.parquet`"]
        n205["`yrbss_state_age_demographics.parquet`"]
    end
    ...
    s30 --> n24
    s20 --> n25
    s31---s32["<strong><a href="https://data.cms.gov/tools/mapping-medicare-disparities-by-population" target="_blank" rel="noreferrer">Mapping Medicare Disparities by Population Tool</a></strong>"]
    s32 --> n26
    s33 --> n26
    s32 --> n27
    s33 --> n27
    s32 --> n28
    s33 --> n28
    s34---s35["<strong><a href="https://cmu-delphi.github.io/delphi-epidata/" target="_blank" rel="noreferrer">Epidata API, claims_outpatient source</a></strong>"]
    s35 --> n29
    s35 --> n30
    ...
    n64 --> bundle_antimicrobial_resistance
    n65 --> bundle_antimicrobial_resistance
    n28 --> bundle_cancer_screening
    n27 --> bundle_cancer_screening
    n26 --> bundle_cancer_screening
    n60 --> bundle_cancer_screening
    n69 --> bundle_cancer_screening
    n25 --> bundle_census
    n20 --> bundle_census
    n22 --> bundle_census
    n24 --> bundle_census
    ...
    n64 --> bundle_enteric_diseases
    n65 --> bundle_enteric_diseases
    n67 --> bundle_enteric_diseases
    n38 --> bundle_enteric_diseases
    n40 --> bundle_enteric_diseases
    n105 --> bundle_injury_overdose
    n28 --> bundle_injury_overdose
    n72 --> bundle_injury_overdose
    ...
    n95 --> bundle_measles
    n55 --> bundle_measles
    n60 --> bundle_preventative_services
    n28 --> bundle_preventative_services
    n27 --> bundle_preventative_services
    n26 --> bundle_preventative_services
    n47 --> bundle_respiratory
    n45 --> bundle_respiratory
    ...
    n88 --> bundle_respiratory
    n12 --> bundle_vector_borne
    n88 --> bundle_vector_borne
    n11 --> bundle_vector_borne
    n105 --> bundle_youth_wellbeing
    ...
    n89 --> bundle_youth_wellbeing
    n76 --> bundle_youth_wellbeing
    n80 --> bundle_youth_wellbeing
    n74 --> bundle_youth_wellbeing
