...
flowchart LR
    ...
    s40(("<strong><a href="https://data.cdc.gov/d/xkb8-kh2a" target="_blank" rel="noreferrer">NCHS VSRR Provisional Drug Overdose Death Counts (State)</a></strong>"))
    s41(("<strong><a href="https://data.cdc.gov/d/gb4e-yj24" target="_blank" rel="noreferrer">NCHS VSRR Provisional County-Level Drug Overdose Death Counts</a></strong>"))
    s42(("<strong><a href="https://data.cdc.gov/d/489q-934x" target="_blank" rel="noreferrer">NCHS VSRR Quarterly Provisional Estimates for Selected Indicators of Mortality</a></strong>"))
    s43(("<strong><a href="https://www.nhtsa.gov/file-downloads?p=nhtsa/downloads/FARS/" target="_blank" rel="noreferrer">Fatality Analysis Reporting System (FARS)</a></strong>"))
    ...
    subgraph cdc_cfa_rt["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/cdc_cfa_rt" target="_blank" rel="noreferrer">cdc_cfa_rt</a></strong>`"]
        direction LR
        n6["`data.csv.gz<br /><br />Script Failed:<br />`"]:::fail
    end
    ...
    subgraph epic_chronic["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/epic_chronic" target="_blank" rel="noreferrer">epic_chronic</a></strong>`"]
        direction LR
        n20["`county_no_time.csv.gz<br/><br/><ul><li><code>missing_info: bmi_30_49.8, obesity_(%), n_obesity_county, Year</code></li></ul>`"]:::warn
        n21["`county_year.csv.gz`"]:::pass
        n22["`state_no_time.csv.gz<br/><br/><ul><li><code>missing_info: bmi_30_49.8, dm_(%), n_patients, Year</code></li></ul>`"]:::warn
        n23["`state_year.csv.gz`"]:::pass
    end
    ...
    subgraph kinsa_ili["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/kinsa_ili" target="_blank" rel="noreferrer">kinsa_ili</a></strong>`"]
        direction LR
        n36["`data.csv-MWMJ0G3P8D.gz<br /><br />Script Failed:<br />Kinsa credentials not found. Set KINSA_EMAIL and KINSA_PASSWORD.`"]:::fail
    ...
    subgraph narms["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/narms" target="_blank" rel="noreferrer">narms</a></strong>`"]
        direction LR
        n47["`data_animal_pathogen.csv.gz<br/><br/><ul><li><code>missing_info: genus, host_species, collection_source, antimicrobial</code></li></ul>`"]:::warn
        n48["`data_food_animals.csv.gz<br/><br/><ul><li><code>missing_info: source_program, source_type, genus, species, serotype, host_species, antimicrobial</code></li></ul>`"]:::warn
        n49["`data_resistance_agent.csv.gz<br/><br/><ul><li><code>missing_info: genus, species_serotype, antimicrobial_class, antimicrobial_agent, test_method</code></li></ul>`"]:::warn
        n50["`data_resistance_pattern.csv.gz<br/><br/><ul><li><code>missing_info: genus, species_serotype, pattern, test_method</code></li></ul>`"]:::warn
        n51["`data_retail_meats.csv<br/><br/><ul><li><code>not_compressed</code></li><li><code>missing_info: genus, species, serotype, meat_source, antimicrobial</code></li></ul>`"]:::warn
        n52["`data_retail_meats.csv.gz<br/><br/><ul><li><code>missing_info: genus, species, serotype, meat_source, antimicrobial</code></li></ul>`"]:::warn
    end
    ...
    subgraph nhtsa_crash["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/nhtsa_crash" target="_blank" rel="noreferrer">nhtsa_crash</a></strong>`"]
        direction LR
        n56["`data_age_sex.csv.gz<br/><br/><ul><li><code>missing_info: age, sex</code></li></ul><br />Script Failed:<br />cannot open URL 'https://static.nhtsa.gov/nhtsa/downloads/FARS/200/National/FARS200NationalCSV.zip'`"]:::fail
        n57["`data_crash_type.csv.gz<br/><br/><ul><li><code>missing_info: age, sex</code></li></ul><br />Script Failed:<br />cannot open URL 'https://static.nhtsa.gov/nhtsa/downloads/FARS/200/National/FARS200NationalCSV.zip'`"]:::fail
        n58["`data_person_type.csv.gz<br/><br/><ul><li><code>missing_info: person_type</code></li></ul><br />Script Failed:<br />cannot open URL 'https://static.nhtsa.gov/nhtsa/downloads/FARS/200/National/FARS200NationalCSV.zip'`"]:::fail
        n59["`data.csv.gz<br /><br />Script Failed:<br />cannot open URL 'https://static.nhtsa.gov/nhtsa/downloads/FARS/200/National/FARS200NationalCSV.zip'`"]:::fail
    end
    subgraph nis["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/nis" target="_blank" rel="noreferrer">nis</a></strong>`"]
        direction LR
        n60["`data_insurance.csv.gz`"]:::pass
        n61["`data_urban.csv.gz`"]:::pass
    ...
    subgraph nnds["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/nnds" target="_blank" rel="noreferrer">nnds</a></strong>`"]
        direction LR
        n63["`data.csv.gz<br/><br/><ul><li><code>missing_info: mmwr_year, mmwr_week, anthrax, cholera, plague, rabies_human, rubella_congenital_syndrome, novel_influenza_a_virus_infections_total, novel_influenza_a_virus_infections_confirmed</code></li></ul><br />Script Failed:<br />In argument: 'time = +...'.`"]:::fail
    end
    subgraph noaa_heat_risk["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/noaa_heat_risk" target="_blank" rel="noreferrer">noaa_heat_risk</a></strong>`"]
        direction LR
        n64["`data_county.csv-MWMJ0G3P8D.gz<br/><br/><ul><li><code>missing_info: value, forecast_day, low_coverage_flag</code></li></ul><br />Script Failed:<br />`"]:::fail
        n65["`data_county.csv.gz<br/><br/><ul><li><code>missing_info: value, forecast_day, low_coverage_flag</code></li></ul><br />Script Failed:<br />`"]:::fail
        n66["`data_state.csv-MWMJ0G3P8D.gz<br/><br/><ul><li><code>missing_info: value, forecast_day</code></li></ul><br />Script Failed:<br />`"]:::fail
        n67["`data_state.csv.gz<br/><br/><ul><li><code>missing_info: value, forecast_day</code></li></ul><br />Script Failed:<br />`"]:::fail
    end
    ...
    subgraph schoolvax_washpost["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/schoolvax_washpost" target="_blank" rel="noreferrer">schoolvax_washpost</a></strong>`"]
        direction LR
        n71["`data_counties.csv.gz<br/><br/><ul><li><code>geography_dropped</code></li></ul>`"]:::warn
        n72["`data_schools.csv.gz`"]:::pass
    end
    subgraph schoolvaxview["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/schoolvaxview" target="_blank" rel="noreferrer">schoolvaxview</a></strong>`"]
        direction LR
        n73["`data_exemptions.csv.gz`"]:::pass
    ...
    subgraph vaccine_exemptions_fattah["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/vaccine_exemptions_fattah" target="_blank" rel="noreferrer">vaccine_exemptions_fattah</a></strong>`"]
        direction LR
        n75["`data_county.csv.gz<br/><br/><ul><li><code>missing_info: is_state_estimate</code></li><li><code>type_changed: geography</code></li></ul>`"]:::warn
        n76["`data_state.csv.gz<br/><br/><ul><li><code>type_changed: geography</code></li></ul>`"]:::warn
        n77["`data.csv.gz<br/><br/><ul><li><code>type_changed: geography</code></li></ul>`"]:::warn
    end
    ...
    subgraph bundle_antimicrobial_resistance["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_antimicrobial_resistance" target="_blank" rel="noreferrer">bundle_antimicrobial_resistance</a></strong>`"]
        direction LR
        n82["`resistance_by_agent.parquet`"]
        n83["`resistance_by_pattern.parquet`"]
    end
    subgraph bundle_cancer_screening["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_cancer_screening" target="_blank" rel="noreferrer">bundle_cancer_screening</a></strong>`"]
        direction LR
        n84["`cms_cancer_screening_by_race.parquet`"]
        n85["`cms_cancer_screening_by_sex.parquet`"]
        n86["`cms_cancer_screening_state.parquet`"]
        n87["`combined_cancer_screening.parquet`"]
        n88["`medicaid_cancer_screening.parquet`"]
    end
    subgraph bundle_childhood_immunizations["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_childhood_immunizations" target="_blank" rel="noreferrer">bundle_childhood_immunizations</a></strong>`"]
        direction LR
        n89["`nis_insurance.parquet`"]
        n90["`nis_overall.parquet`"]
        n91["`nis_urban.parquet`"]
        n92["`overall_rates_by_source.parquet`"]
        n93["`schoolvaxview_exemptions.parquet`"]
        n94["`schoolvaxview_overall.parquet`"]
        n95["`state_compare.parquet`"]
        n96["`wapo_vax_counties.parquet`"]
        n97["`wapo_vax_schools.parquet`"]
    end
    subgraph bundle_chronic_diseases["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_chronic_diseases" target="_blank" rel="noreferrer">bundle_chronic_diseases</a></strong>`"]
        direction LR
        n98["`brfss_prevalence_by_geography.parquet`"]
        n99["`county_opioid_by_source.parquet`"]
        n100["`deaths_cause_age.parquet`"]
        n101["`epic_prevalence_by_geography_county_and_source.parquet`"]
        n102["`epic_prevalence_by_geography_county.parquet`"]
        n103["`epic_prevalence_by_geography_year.parquet`"]
        n104["`epic_prevalence_by_geography.parquet`"]
        n105["`overdose_by_geography_and_source_county.parquet`"]
        n106["`overdose_by_geography_and_source.parquet`"]
        n107["`overdose_deaths_county.parquet`"]
        n108["`overdose_deaths_state.parquet`"]
        n109["`prevalence_by_geography_and_source.csv`"]
        n110["`prevalence_by_geography_and_source.parquet`"]
        n111["`prevalence_by_geography_and_year_and_source.parquet`"]
        n112["`prevalence_by_geography_year_and_source.parquet`"]
    end
    ...
    subgraph bundle_injury_overdose["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_injury_overdose" target="_blank" rel="noreferrer">bundle_injury_overdose</a></strong>`"]
        direction LR
        n115["`brfss_prevalence_by_geography.parquet`"]
        n116["`county_opioid_by_source.parquet`"]
        n117["`deaths_cause_age_demographics.parquet`"]
        n118["`deaths_cause_age.parquet`"]
        n119["`epic_prevalence_by_geography_year.parquet`"]
        n120["`firearms_by_demographics.parquet`"]
        n121["`firearms_by_geography_and_source_state_year.parquet`"]
        n122["`firearms_geography_source.parquet`"]
        n123["`google_dma.parquet`"]
        n124["`heat_by_geography_and_source_state_year.parquet`"]
        n125["`heat_related_geography_source.parquet`"]
        n126["`heat_risk-MWMJ0G3P8D.parquet`"]
        n127["`heat_risk.parquet`"]
        n128["`medicaid_injury_overdose.parquet`"]
        n129["`overdose_by_demographics.parquet`"]
        n130["`overdose_by_geography_and_source_county.parquet`"]
        n131["`overdose_by_geography_and_source_state_year.parquet`"]
        n132["`overdose_by_geography_and_source.parquet`"]
        n133["`overdose_deaths_county.parquet`"]
        n134["`overdose_deaths_state.parquet`"]
        n135["`state_opioid_by_source.parquet`"]
    end
    subgraph bundle_measles["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_measles" target="_blank" rel="noreferrer">bundle_measles</a></strong>`"]
        direction LR
        n136["`measles_cases_by_age.parquet`"]
        n137["`measles_county.parquet`"]
        n138["`measles_state.parquet`"]
    end
    subgraph bundle_respiratory["`<strong><a href="https://github.com/PopHIVE/Ingest/tree/main/data/bundle_respiratory" target="_blank" rel="noreferrer">bundle_respiratory</a></strong>`"]
        direction LR
        n139["`covid_ed_visits_by_county.parquet`"]
        n140["`covid_overall_trends.parquet`"]
        n141["`covid_trends_by_age.parquet`"]
        n142["`flu_ed_visits_by_county.parquet`"]
        n143["`flu_overall_trends.parquet`"]
        n144["`flu_trends_by_age.parquet`"]
        n145["`pneumococcus_by_geography_year.parquet`"]
        n146["`pneumococcus_by_geography.parquet`"]
        n147["`pneumococcus_comparison.parquet`"]
        n148["`pneumococcus_serotype_trends-MWMJ0G3P8D.parquet`"]
        n149["`pneumococcus_serotype_trends.parquet`"]
        n150["`rsv_ed_visits_by_county.parquet`"]
        n151["`rsv_google_dma.parquet`"]
        n152["`rsv_overall_trends.parquet`"]
        n153["`rsv_positive_tests.parquet`"]
        n154["`rsv_testing_pct.parquet`"]
        n155["`rsv_trends_by_age.parquet`"]
    end
    ...
    s40 --> n55
    s41 --> n55
    s43---s44["<strong><a href="https://www.nhtsa.gov/file-downloads?p=nhtsa/downloads/FARS/" target="_blank" rel="noreferrer">NHTSA File Downloads — FARS National CSV archives</a></strong>"]
    s44 --> n56
    s44 --> n57
    s44 --> n58
    s44 --> n59
    ...
    n47 --> bundle_antimicrobial_resistance
